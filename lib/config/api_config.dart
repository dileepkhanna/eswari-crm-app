class ApiConfig {
  ...
  // static const String baseUrl = 'http://192.168.0.159:8000/api'; // Real device on WiFi
  static const String baseUrl = 'http://localhost:8000/api'; // Real device via ADB reverse
